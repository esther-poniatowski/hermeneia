...
class LanguageLexicons:
    ...
    citation_agent_verbs: tuple[str, ...] = ()
    citation_object_verbs: tuple[str, ...] = ()
    citation_forbidden_prepositions: tuple[str, ...] = ()
    citation_context_nouns: tuple[str, ...] = ()
    structural_metalanguage_terms: tuple[str, ...] = ()
    structural_metalanguage_positions: tuple[str, ...] = ()
    ...
    explicit_contrast_markers: tuple[str, ...] = ()
    contrast_polarity_positive_terms: tuple[str, ...] = ()
    contrast_polarity_negative_terms: tuple[str, ...] = ()
    transition_connectors: tuple[str, ...] = ()
    transition_reference_heads: tuple[str, ...] = ()
    conditional_consequence_markers: tuple[str, ...] = ()
    inline_case_condition_markers: tuple[str, ...] = ()
    inline_case_fallback_markers: tuple[str, ...] = ()
    ...
    taxonomy_cardinality_targets: tuple[str, ...] = ()
    cardinality_number_words: tuple[str, ...] = ()
    filler_noun_terms: tuple[str, ...] = ()
