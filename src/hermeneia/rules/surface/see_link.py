        ...
        for line in lines:
            ...
            violations.append(
                Violation(
                    ...
                    message=(
                        "Avoid 'See [link]' scaffolding; integrate the reference into the "
                        "sentence with descriptive anchor text."
                    ),
                    ...
                    rewrite_tactics=(
                        "Name the referenced object directly and keep the link as part of the clause.",
                    ),
                )
            )
        return violations
