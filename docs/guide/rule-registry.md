...
| `math.bare_pronoun_after_display` | Bare-pronoun follow-up ban | Immediately after display math, bare pronoun openings obscure what object is being referenced. | Display equation followed by "It follows that ..." / "This gives ..." | "The bound implies that ..." / "This expression gives ..." |
