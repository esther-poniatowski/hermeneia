...
| `structure.opening_sentence_presence` | Opening sentence presence | Documents should begin with one purpose sentence before structured content blocks. | File starts with a list/table/code/display block | Add one opening sentence before structured content |
