...
This file defines pedagogical requirements for all mathematical notes. These requirements operate at the level of sections and paragraphs, below the structural requirements in `note-template.md` and above the sentence-level rules in `style-hard-rules.md`.
