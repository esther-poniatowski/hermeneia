...
- `hermeneia`          : Repository name
- `esther-poniatowski`        : GitHub username of the project owner
- `hermeneia`       : Python package name
- `hermeneia`           : Conda environment name
...
1. Initialize a local copy of the repository:
   ...
   git clone git@github.com:esther-poniatowski/hermeneia.git
   ```
...
2. Create a virtual environment containing the development dependencies:
   ...
   By default, the environment will be named `hermeneia`, as specified in the `environment.yml`
